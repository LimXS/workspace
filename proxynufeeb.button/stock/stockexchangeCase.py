...
class stockexchangeTest(unittest.TestCase):
    ...
    def teststockExchange(self):
        ...
        #页面id
        pageurl=browser.xmlRead(dom,"stexurl",0)
        ...
        try:
            ...
            #折前单价
            oudpprice=commid["basetype"]+pageid+itemgrid+str(23)+"]"
            ...
            #折前单价
            indpprice=commid["basetype"]+pageid+initemgrid+str(23)+"]"
            #print indpprice
            ...
            browser.findId(self.driver,summid).send_keys(u"中文测试饕餮壹贰123！@#￥%……&*（）()； abcstock exchange  summary")

            #附加说明
            commentid=pageid+browser.xmlRead(dom,'edComment',0)
            browser.findId(self.driver,commentid).send_keys(u"中文测试饕餮壹贰123！@#￥%……&*（）()； abcstock exchange comment")
            ...
            browser.getpicture(self.driver,filename+u"进货-进货换货单.png")
