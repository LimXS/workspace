...
class browser(base):
    ...
    def set_up(self,driver):
        #url="http://dba.wsgjp.com.cn/"
        #url="http://bfunfunc1.mygjp.com/"
        url="http://dba.wsgjp.com.cn/"
        driver.get(url)
    ...
    def notecentel(self,header):
        url="http://dba.wsgjp.com.cn.cn/Carpa.Web/Carpa.Web.Script.DataService.ajax/GetPagerData"
    ...
    def reportsumdata(self,id,header):
        reurlsum="http://dba.wsgjp.com.cn/Carpa.Web/Carpa.Web.Script.DataService.ajax/GetPagerSummary"
        resumda={"pagerId":id}
    ...
    def catestatus(self,header,flag):
        urlid="http://dba.wsgjp.com.cn/Beefun/Report/StockStateReportNew.gspx"
        idtext=requests.get(url=urlid,headers=header)
        id=self.getpageid(idtext)
        #明细
        urllist="http://dba.wsgjp.com.cn/Carpa.Web/Carpa.Web.Script.DataService.ajax/GetPagerData"
    ...
    def subjectdetail(self,vcode,header):
        ...
        saledataurl="http://dba.wsgjp.com.cn/Beefun/Beefun.Bill.SaleBackBill.ajax/LoadDlyaString"
    ...
    def pageidsum(self,urlid,header):
        ...
        #detail
        #urldetail="http://dba.wsgjp.com.cn/Carpa.Web/Carpa.Web.Script.DataService.ajax/GetPagerData"

        #sum
        #print id
        urlsum2="http://dba.wsgjp.com.cn/Carpa.Web/Carpa.Web.Script.DataService.ajax/GetPagerSummary"
        sumdata2={"pagerId":id}
    ...
    def vipinfo(self,header):
        #pageid
        urlid="http://dba.wsgjp.com.cn/Beefun/VipMember/VipMemberList.gspx"
    ...
    def seriesiteminto(self,driver,itemsel,itemone):
        ...
        f=open(r'C:\workspace\proxynufeeb.button\instock\instockortherseries','w')
        f.write(itemser)
        f.close()
