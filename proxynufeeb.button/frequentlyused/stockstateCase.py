...
class stockstateTest(unittest.TestCase):
    ...
    def teststockState(self):
        ...
        pid="869585272784951"
        saleayaurl="http://dba.wsgjp.com.cn/Beefun/Report/SaleStockDetailList.gspx?ptypeid="+pid+"&ktypeids=&stockname="+stockname
        ...
        try:
            ...
            cateajusturl="http://dba.wsgjp.com.cn/Beefun/Bill/StockAdjustBill.gspx"
