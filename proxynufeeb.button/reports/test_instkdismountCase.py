...
class inskdismountTest(unittest.TestCase):
    u'''报表-库存报表-拆装单统计'''
    ...
    def test_invskdismount(self):
        ...
        moduledd=browser.xmlRead(dom,'invadd',4)
        ...
        try:
            ...
            browser.getpicture(self.driver,filename+u"报表-库存报表-拆装单统计.png")
