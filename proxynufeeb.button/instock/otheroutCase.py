...
class otheroutTest(unittest.TestCase):
    ...
    def testotheritemseriesout(self):
        ...
        try:
            ...
            browser.findId(self.driver,summid).send_keys(u"中文测试饕餮壹贰！@#￥%……&*（）12；other out series item summary")

            #附加说明
            commentid=pageid+browser.xmlRead(dom,'edComment',0)
            browser.findId(self.driver,commentid).send_keys(u"other out series item comment中文测试饕餮壹贰！@#￥%……&*（）12；")
