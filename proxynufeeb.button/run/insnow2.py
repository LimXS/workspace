    ...
    for a in range(num):
        ...
        billdata=(
            {"orderEntity":{"atypeid":0,"buyerid":0,"tradeid":becode+browser.getrandnumber()+str(a),"number":None,"payno":"","gatheringvchcode":0,
                        "tradecreatetime":overtime,"trademodifiedtime":overtime,"modifiedtime":overtime,"orderupdatetime":None,"steptradedeliverytime":None,
                        ...
                        "eshopname":etypename,"btypeid":"28455803329961343","etypeid":"3121930940033791","createtime":overday,"customerpayaccount":"",
...
def sendpro(num):
    ...
    if num==0:
        ...
        senddatas=createorder(5500,"TEST2DeSendItem")
