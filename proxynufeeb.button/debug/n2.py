...
def getsubdata():
    ...
    #审核
    fc=open(r"E:\vccheck3.txt")
    item=fc.read().strip()
    all2=re.findall("values\('(.*?)'",item)

    fc2=open(r"E:\vccheckitem3.txt")
    item=fc2.read().strip()
...
def sendpro(num):
    ...
    nskcookie=fc.read()
    browser.delaytime(1)
    f2=open(r"D:\cookies\eshop9.txt")
    nskcookie2=f2.read()
    browser.delaytime(1)
    f3=open(r"D:\cookies\eshop8.txt")
    nskcookie3=f3.read()
    browser.delaytime(1)
    f4=open(r"D:\cookies\eshop7.txt")
    nskcookie4=f4.read()
    f5=open(r"D:\cookies\eshop6.txt")
    nskcookie5=f5.read()
    global headers
    global headers2
    global headers3
