...
def sendandcompare(senddata,headers):
    ...
    '''
    f=open(r"D:\cookies\beestocksave.txt")
    nskcookie=f.read()
    #print nskcookie
    ...
    for a in range(0,100):
        stockurlsave="http://beefun.wsgjp.com//Beefun/Beefun.Bill.StockOrderBill.ajax/Save"
        nskdata=(
        {"bill":{"date":"2016-12-27","draft":False,"displaynumber":"","number":"TEST3-JHD20161227a-"+browser.getrandnumber()+str(a),"inputno":"2605638079543105363",
                 "inputfullname":"xsx","redword":False,"redold":False,"billtype":0,"ktypeid":"2605638079543104740","kfullname":"主仓库",
                 "btypetax":0,"todate":today,"efullname":"001","currencyid":0,"btypeid":"2605638088187950285",
                 "bfullname":"t5123443","etypeid":"2605638088210451192","summary":"222222222222"+browser.getrandnumber(),"comment":"222222222222"+browser.getrandnumber(),
                 "details":[{"prop1":0,"prop1name":"","prop2":0,"prop2name":"","prop3":0,"prop3name":"",
                         "pic_url":"http://wd.geilicdn.com/vshop520219391-1459218328272-4913776.png?w=480&h=0","ptypeid":"869585272784951",
                         "pfullname":"002 无编码修改_Ax","pname":"002","ptypecode":"a1x","brandname":"","temp_ucode":"a1x","temp_ucode_flag":True,
                         "ptypeunit":"个","unit":"1","unitrate":1,"ptypestandard":"","ptypetype":"","ptypearea":"","snenabled":0,"ptypeweight":0,
        ...
        datas={"pagerId":"$609e9e2b$grid_pager1","queryParams":{"vchType":7,"xTypeid":"","isComplete":"1","isAudit":0,"isExport":"-1","dlytype":-1},"orders":None,"filter":None,"first":0,"count":50000}
        st = time.time()
    ...
    for vchcode in vchcodelist:
        urlskcheck="http://beefun.wsgjp.com//Beefun/Beefun.Carrier.OrderManager.ajax/UpdateAuditOver"
        #headers={'cookie':nskcookie,"Content-Type": "application/json"}
    ...
    for vchcode in vchcodelist:
    #进货入库
        intoskurl="http://beefun.wsgjp.com//Beefun/Beefun.Bill.StockBill.ajax/Save"
        inskdata=(
        ...
        print pageorderdata
        #单据中心
        notecenurl="http://beefun.wsgjp.com//Carpa.Web/Carpa.Web.Script.DataService.ajax/GetPagerData"
        ...
        f=open(r"D:\cookies\beecennote.txt")
        nskcookie=f.read()
        #print nskcookie
        headers={'cookie':nskcookie,"Content-Type": "application/json"}
    ...
    #退货
    for vchcode in vchcodelist:
        reinkurl="http://beefun.wsgjp.com//Beefun/Beefun.Bill.StockBackBill.ajax/Save"
        reinkdata=(
    ...
    for vchcode2 in vchcodelist:
        #销售
        newsaleurl="http://beefun.wsgjp.com//Beefun/Beefun.Bill.SaleOrderBill.ajax/Save"
        nsaldata=(
    ...
    for vchcode in salevchodelist:
        #审核
        slcheckurl="http://beefun.wsgjp.com//Beefun/Beefun.Carrier.OrderManager.ajax/UpdateAuditOver"
    ...
    for vchcode in salevchodelist:
        #出库
        slurl="http://beefun.wsgjp.com//Beefun/Beefun.Bill.SaleBill.ajax/Save"
        sldata=(
    ...
    for vchcode in salevchodelist:
        #退货
        salreurl="http://beefun.wsgjp.com//Beefun/Beefun.Bill.SaleBackBill.ajax/Save"
        salredata=(
...
def newcookie():
    ...
    while 1:
        try:
            ...
            #browser.set_up(driver)
            #driver.get("http://beefun.wsgjp.com//")
            ...
            reskdel="http://beefun.wsgjp.com//Carpa.Web/Carpa.Web.Script.DataService.ajax/GetPagerData"
...
def main():
    a=random.sample(range(2000,3000,1),49)
    '''
