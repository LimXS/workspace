...
def sendpro(num):
    ...
    if num==0:
        ...
        senddatas=createorder(1000,"1TEST4CreateOrder")
        data=pool.map(selgreenf,senddatas)
    elif num==1:
        sendurl="http://hehe.wsgjp.com.cn/Beefun/Beefun.EShopSale.EShopSaleOrderCreate.ajax/SaveAndAuditSaleOrder"
        senddatas=createorder(1000,"1TEST4DeCheck")
        data=pool.map(selgreenf2,senddatas)

    elif num==2:
        sendurl="http://hehe.wsgjp.com.cn/Beefun/Beefun.EShopSale.EShopSaleOrderCreate.ajax/SaveAndAuditSaleOrder"
        senddatas=createorder(1000,"1TEST4DePrint")
        data=pool.map(selgreenf3,senddatas)

    elif num==3:
        sendurl="http://hehe.wsgjp.com.cn/Beefun/Beefun.EShopSale.EShopSaleOrderCreate.ajax/SaveAndAuditSaleOrder"
        senddatas=createorder(1000,"1TEST4DeCheckItem")
        data=pool.map(selgreenf4,senddatas)
    else:
        sendurl="http://hehe.wsgjp.com.cn/Beefun/Beefun.EShopSale.EShopSaleOrderCreate.ajax/SaveAndAuditSaleOrder"
        senddatas=createorder(1000,"1TEST4DeSendItem")
