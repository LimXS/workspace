...
def createorderdata(n):
    ...
    for k in range(n):
        nskdata=(
        {"bill":{"date":"2016-12-27","draft":False,"displaynumber":"","number":"TEST2-JHD20161229-"+rannum[:-6]+str(k),"inputno":"2605638079543105363",
...
def sendandcompare(senddata,headers):
    ...
    nskdata=(
        {"bill":{"date":"2016-12-27","draft":False,"displaynumber":"","number":"TEST3-JHD20161227a-"+browser.getrandnumber(),"inputno":"2605638079543105363",
                 "inputfullname":"xsx","redword":False,"redold":False,"billtype":0,"ktypeid":"2605638079543104740","kfullname":"主仓库",
                 "btypetax":0,"todate":today,"efullname":"001","currencyid":0,"btypeid":"2605638088187950285",
    ...
    datas={"pagerId":"$609e9e2b$grid_pager1","queryParams":{"vchType":7,"xTypeid":"","isComplete":"1","isAudit":0,"isExport":"-1","dlytype":-1},"orders":None,"filter":None,"first":0,"count":25}
    st = time.time()
    ...
    nsaldata=(
        {"bill":{"date":"2016-12-27","draft":False,"displaynumber":"","number":"TEST1SHD-"+vchcode+browser.getrandnumber(),"inputno":"2605638079543105363",
             "inputfullname":"xsx","redword":False,"redold":False,"billtype":0,"ktypeid":"2605638079543104740","kfullname":"主仓库",
    ...
    #单据中心
    notecenurl="http://dba.wsgjp.com.cn/Carpa.Web/Carpa.Web.Script.DataService.ajax/GetPagerData"
    notdata={"pagerId":"$c3e1bf43$grid_pager1","queryParams":{"vchtype":"","beginDate":"2016-12-20","endDate":"2016-12-30","redwordType":0,"dlyType":0},"orders":None,"filter":None,"first":0,"count":100}
    f=open(r"D:\cookies\cennote.txt")
    nskcookie=f.read()
    #print nskcookie
    headers={'cookie':nskcookie,"Content-Type": "application/json"}
...
def main():
    a=random.sample(range(50,100,1),49)
    '''
    ...
    for num in a:
        ...
        senddata=createorderdata(20000)
        #n=0
        print len(senddata)
        num_of_threads = num
        _st = time.time()
