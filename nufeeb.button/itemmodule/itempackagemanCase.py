...
class itempackagemanTest(unittest.TestCase):
    ...
    def testitempackageMan(self):
        ...
        try:
            ...
            addhandurl="http://beefun.wsgjp.com/Beefun/EShopCombo/EShopComboCreate.gspx"
            ...
            browser.findId(self.driver,ahid+edName).send_keys("button_test"+str(code))
            ...
            browser.findId(self.driver,ahid+edRemark).send_keys(u"饕餮蘩軆中文测试！@#~￥%……&*（）； buttontestremain")
            ...
            seliturl="http://beefun.wsgjp.com/Beefun/EShopProduct/PTypeAndComboSelector.gspx?showSuit=False&MultiSelect=True&ptypeType=0"
            ...
            itaddurl="http://beefun.wsgjp.com/Beefun/BaseInfo2/PTypeEdit.gspx?Mode=Add&ParTypeId=00000&type=add"
            ...
            importurl="http://beefun.wsgjp.com/Beefun/IniPeriod/ImportCombo.gspx"
            ...
            browser.delaytime(1)
            browser.findId(self.driver,editscon).click()
            changedis=commid["basetype"]+pageid+quickEditMenu+str(2)+combol
            browser.findXpath(self.driver,changedis).click()
            browser.delaytime(1)
            ...
            #查询
            pagesel=pageid+commid["button"]+str(7)
