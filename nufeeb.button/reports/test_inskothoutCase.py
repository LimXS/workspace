...
class inskothoutTest(unittest.TestCase):
    u'''报表-库存报表-其他出库单统计'''
    ...
    def test_invskothout(self):
        ...
        moduledd=browser.xmlRead(dom,'invadd',6)
        ...
        try:
            ...
            browser.getpicture(self.driver,filename+u"报表-库存报表-其他出库单统计.png")
