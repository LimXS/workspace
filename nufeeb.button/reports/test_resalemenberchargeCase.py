...
class resalemenberchargeTest(unittest.TestCase):
    ...
    def test_resalemenberCharge(self):
        u'''报表-批发零售报表-会员储值变动记录'''
        ...
        moduledd=browser.xmlRead(dom,'saleadd',11)
        ...
        try:
            ...
            browser.getpicture(self.driver,filename+u"报表-批发零售报表-会员储值变动记录.png")
