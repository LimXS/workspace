...
class resaleitemTest(unittest.TestCase):
    u'''报表-批发零售报表-商品销售统计'''
    ...
    def test_resaleItem(self):
        ...
        moduledd=browser.xmlRead(dom,'saleadd',1)
        ...
        try:
            ...
            browser.getpicture(self.driver,filename+u"报表-批发零售报表-商品销售统计.png")
