...
class insklessTest(unittest.TestCase):
    u'''报表-库存报表-报损单统计'''
    ...
    def test_invskless(self):
        ...
        moduledd=browser.xmlRead(dom,'invadd',1)
        ...
        try:
            ...
            browser.getpicture(self.driver,filename+u"报表-库存报表-报损单统计.png")
