...
class depcostgridTest(unittest.TestCase):
    u'''报表-部门职员业务分析-部门费用分布'''
    ...
    def test_depCostgrid(self):
        ...
        moduledd=browser.xmlRead(dom,'depadd',0)
        ...
        try:
            ...
            browser.delaytime(1)
            browser.getpicture(self.driver,filename+u"报表-部门职员业务分析-部门费用分布.png")
