...
class inskinnerTest(unittest.TestCase):
    u'''报表-库存报表-内部领用统计'''
    ...
    def test_invstkInner(self):
        ...
        moduledd=browser.xmlRead(dom,'invadd',7)
        ...
        try:
            ...
            browser.getpicture(self.driver,filename+u"报表-库存报表-内部领用统计.png")
