...
class alarmdownTest(unittest.TestCase):
    u'''库存-库存报警-库存下限报警表'''
    ...
    def testalarmDown(self):
        ...
        try:
            ...
            jszai="$(\"div[class=GridBodyCellText]:contains('331')\").attr(\"id\",\"tempid\")"
            browser.delaytime(1)
            ...
            browser.getpicture(self.driver,filename+u"库存-库存报警-库存下限报警表.png")
