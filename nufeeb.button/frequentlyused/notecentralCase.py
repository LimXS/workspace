...
class notecentralTest(unittest.TestCase):
    ...
    def testnoteCentral(self):
        ...
        try:
            ...
            #页面id
            pageurl="http://beefun.wsgjp.com/Beefun/Assistant/BusinessHistory.gspx"
            ...
            ppeourl="http://beefun.wsgjp.com/Beefun/Assistant/BusinessHistoryUpdateEmployee.gspx"
            ...
            #选中
            peourl="http://beefun.wsgjp.com/Beefun/Selector/ETypeSelector.gspx?SelectClass=False&&HideStoppedItem=True&Add=False&Mode=Money"
